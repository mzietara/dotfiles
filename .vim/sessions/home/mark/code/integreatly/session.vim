...
argglobal
%argdel
edit apps/igy/src/integreat.ly/store/appointment.go
...
set winwidth=1
argglobal
balt apps/igy/src/integreat.ly/store/workshift.go
let s:cpo_save=&cpo
set cpo&vim
...
nnoremap <buffer>  l :GoRun
nnoremap <buffer>  k :GoTest
...
normal! 013|
tabnext 1
badd +16 apps/igy/src/integreat.ly/store/workshift.go
badd +0 apps/igy/src/integreat.ly/store/appointment.go
badd +1 tags
badd +197 ~/.vimrc
