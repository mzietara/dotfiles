...
nnoremap  R gD:%s////gc<Left><Left><Left>"}]
nnoremap  r gd[{V%::s////gc<Left><Left><Left>
nnoremap  c 
nnoremap  x 
map  F :FZF 
map  f :FZF
...
set ruler
set runtimepath=~/.vim,~/.vim/pack/vim-go/start/vim-go,~/.vim/pack/vendor/start/nerdtree,~/.vim/pack/tpope/start/fugitive,~/.vim/pack/tpope/start/dispatch,~/.vim/pack/scrooloose/start/syntastic,~/.vim/pack/plugins/start/lightline,~/.vim/pack/git-plugins/start/ale,~/.vim/pack/fzf/start/fzf,~/.vim/pack/airblade/start/vim-gitgutter,~/.vim/pack/ack-plugin/start/ack,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after,~/.fzf
...
argglobal
%argdel
$argadd /tmp/vuTLhf_init-dotfiles.sh
$argadd init-dotfiles.sh
edit /tmp/vuTLhf_init-dotfiles.sh
...
exe 'vert 2resize ' . ((&columns * 91 + 91) / 183)
tabnext 1
badd +1 /tmp/vuTLhf_init-dotfiles.sh
badd +0 init-dotfiles.sh
